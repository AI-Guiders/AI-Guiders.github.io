...
static void WriteArticlePage(Article a, string lang, string outDir, string writingBase)
{
    ...
    var pageTitle = WebUtility.HtmlEncode(a.Title) + (isEn ? " — AI-Guiders" : " — AI-Guiders");
    var siteName = isEn ? "AI-Guiders" : "AI-Guiders";
    var logo = isEn ? "AI<span>-</span>Guiders" : "AI<span>-</span>Guiders";
    ...
    sb.AppendLine($"          <li><a href=\"{home}#stack\">{labels.Projects}</a></li>");
    sb.AppendLine($"          <li><a href=\"{writingBase}\" aria-current=\"page\">{labels.Writing}</a></li>");
    sb.AppendLine($"          <li><a href=\"https://github.com/AI-Guiders/handbook/wiki\">{labels.Experience}</a></li>");
    sb.AppendLine($"          <li><a href=\"https://github.com/AI-Guiders\">{labels.Docs}</a></li>");
    sb.AppendLine("        </ul>");
    ...
    sb.AppendLine($"        <a href=\"https://github.com/AI-Guiders\">{labels.GitHub}</a>");
    sb.AppendLine("      </div>");
...
static void WriteIndex(List<Article> articles, string lang, string outDir)
{
    ...
    var pageTitle = isEn ? "Writing — AI-Guiders" : "Тексты — AI-Guiders";
    var pageDesc = isEn
    ...
    Dictionary<string, (string Display, List<Article> Items)> bySlug)
{
    ...
    var logo = isEn ? "AI<span>-</span>Guiders" : "AI<span>-</span>Guiders";
    var siteName = isEn ? "AI-Guiders" : "AI-Guiders";
    var pageTitle = isEn ? "Tags — AI-Guiders" : "Теги — AI-Guiders";
...
static void WriteTagPage(string slug, string display, List<Article> items, string lang, string tagOutDir, string writingBase)
{
    ...
    var logo = isEn ? "AI<span>-</span>Guiders" : "AI<span>-</span>Guiders";
    var siteName = isEn ? "AI-Guiders" : "AI-Guiders";
    var pageTitle = (isEn ? "Tag: " : "Тег: ") + display + (isEn ? " — AI-Guiders" : " — AI-Guiders");
...
{
    const string siteOrigin = "https://ai-guiders.github.io";
    var isEn = lang == "en";
    var feedTitle = isEn ? "Writing — AI-Guiders" : "Тексты — AI-Guiders";
    ...
    sb.AppendLine("  <author><name>AI-Guiders</name></author>");
